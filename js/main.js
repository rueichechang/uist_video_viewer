...
const refs = {
  ...
  playerControls: byId('playerControls'),
  speedBtn: byId('speedBtn'),
  scrubTrack: byId('scrubTrack'),
  scrubFill: byId('scrubFill'),
  scrubHandle: byId('scrubHandle'),
  scrubCurrent: byId('scrubCurrent'),
  scrubTotal: byId('scrubTotal'),
...
function init() {
  ...
  player.init({
    ...
    playerControls: refs.playerControls,
    speedBtn: refs.speedBtn,
    scrubTrack: refs.scrubTrack,
    scrubFill: refs.scrubFill,
    scrubHandle: refs.scrubHandle,
    scrubCurrent: refs.scrubCurrent,
    scrubTotal: refs.scrubTotal,
    shell: refs.shell,
